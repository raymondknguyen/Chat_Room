...
bike5 = GearItem.create(name: 'Ibis Ripley GX Eagle 2019 Bike', description: Faker::Lorem.paragraph, price: Faker::Commerce.price, condition: 0, status: 0, location: "1662 S Pearl St, Denver, CO 80210", owner: collin, photo: "https://outdoorgearlab-mvnab3pwrvp3t0.stackpathdns.com/photos/19/48/316277_12754_S.jpg")
